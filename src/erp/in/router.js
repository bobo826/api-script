  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        title: '特殊发货申请',
        apiPath:
          '/api/erp/ae/apply/delivery/listDeliveryApply,/api/erp/ae/apply/delivery/create,/api/erp/ae/apply/delivery/deliveryApplySwitch',
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        hideInMenu: true,
        apiPath:
          '/api/erp/ae/category/add,/api/erp/ae/goods/detail,/api/erp/ae/goods/add,/api/erp/ae/category/edit,/api/erp/ae/goods/edit,/api/erp/ae/category/list,/api/erp/ae/purchase-order/getGoods,/api/erp/ae/purchase-order/listDetail,/api/erp/ae/goods/search-goods,/api/erp/ae/goods/list',
      ...
      },
      {
        ...
        title: '内容包映射',
        apiPath:
          '/api/erp/ae/gift/good/save,/api/erp/ae/course-goods/add,/api/erp/ae/return-order/delete,/api/erp/ae/gift/good/delete,/api/erp/ae/course-goods/delete,/api/erp/ae/gift/good/stopGiftGoods,/api/erp/ae/course-goods/disable,/api/erp/ae/course-goods/studySegment,/api/erp/ae/course-goods/list,/api/erp/ae/gift/good/auditGiftGoods,/api/erp/ae/course-goods/confirm,/api/erp/ae/course-goods/reject,/api/erp/ae/course-goods/detail,/api/erp/ae/course-goods/edit,/api/erp/ae/course-goods/synToWms,/api/erp/ae/category/list,/api/erp/ae/purchase-order/getGoods,/api/erp/ae/purchase-order/listDetail,/api/erp/ae/goods/search-goods,/api/erp/ae/goods/list,/api/erp/ae/course-goods/class-list,/api/erp/ae/course-goods/course-list,/api/erp/ae/course-goods/class-delivery-periods,/api/erp/ae/gift/listGift',
      ...
      },
      {
        ...
        title: '礼包实物映射',
        apiPath:
          '/api/erp/ae/gift/good/save,/api/erp/ae/course-goods/add,/api/erp/ae/return-order/delete,/api/erp/ae/gift/good/delete,/api/erp/ae/course-goods/delete,/api/erp/ae/gift/good/stopGiftGoods,/api/erp/ae/course-goods/disable,/api/erp/ae/course-goods/studySegment,/api/erp/ae/gift/good/getGiftGoodsInfoById,/api/erp/ae/gift/good/list,/api/erp/ae/gift/good/auditGiftGoods,/api/erp/ae/course-goods/confirm,/api/erp/ae/course-goods/reject,/api/erp/ae/course-goods/edit,/api/erp/ae/price-adjust/submit,/api/erp/ae/return-order/submit,/api/erp/ae/gift/good/submitGiftGoods,/api/erp/ae/statement/audit,/api/erp/ae/billing/submit,/api/erp/ae/category/list,/api/erp/ae/purchase-order/getGoods,/api/erp/ae/purchase-order/listDetail,/api/erp/ae/goods/search-goods,/api/erp/ae/goods/list,/api/erp/ae/course-goods/class-list,/api/erp/ae/course-goods/course-list,/api/erp/ae/gift/listGift,/api/erp/ae/course-goods/class-delivery-periods',
      ...
      },
      {
        ...
        title: '品类分类',
        apiPath:
          '/api/erp/ae/category/list,/api/erp/ae/category/add,/api/erp/ae/goods/add,/api/erp/ae/category/edit,/api/erp/ae/goods/edit',
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        title: '到货单管理',
        apiPath:
          '/api/erp/ae/warehouse/getWarehouseList,/api/erp/ae/asn/differenceConfirm,/api/erp/ae/return-order/detail,/api/erp/ae/supplier/listSupplier,/api/erp/ae/billing/detail,/api/erp/ae/asn/listDifferenceConfirm,/api/erp/ae/asn/list,/api/erp/ae/asn/getViewById,/api/erp/ae/price-adjust/getInfoById,/api/erp/ae/supplier/detail,/api/erp/ae/price-adjust-result/findById',
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        title: '采购对账单管理',
        apiPath:
          '/api/erp/ae/billing/feeDetail,/api/erp/ae/statement/payCallBack,/api/erp/ae/billing/payCallBack,/api/erp/ae/statement/printBill,/api/erp/ae/billing/print,/api/erp/ae/billing/list,/api/erp/ae/billing/addMulFee,/api/erp/ae/billing/audit,/api/erp/ae/return-order/delete,/api/erp/ae/billing/deleteMulFee,/api/erp/ae/return-order/detail,/api/erp/ae/billing/detail,/api/erp/ae/billing/downloadFeeDetail,/api/erp/ae/purchase-order/export,/api/erp/ae/price-adjust-result/export,/api/erp/ae/order/exportOrder,/api/erp/ae/order/showTask,/api/ae/common/showTask,/api/erp/ae/inventory/product/exportGoodsInventory,/api/erp/ae/billing/modifyMulFee,/api/erp/ae/return-order/submit,/api/erp/ae/billing/submit,/api/erp/ae/supplier/listSupplierActive,/api/erp/ae/supplier/list,/api/erp/ae/supplier/listSupplier',
      ...
      },
      {
        ...
        title: '待结算订单管理',
        apiPath:
          '/api/erp/ae/waitSettleBilling/billedMoney,/api/erp/ae/waitSettleBilling/billingMoney,/api/erp/ae/waitSettleBilling/list,/api/erp/ae/waitSettleBilling/countData,/api/erp/ae/waitSettleBilling/createBilling,/api/erp/ae/supplier/listSupplierActive,/api/erp/ae/supplier/list,/api/erp/ae/supplier/listSupplier',
      ...
      },
      {
        ...
        title: '调拨明细-寄售',
        apiPath:
          '/api/erp/ae/billing/transfer/list,/api/erp/ae/billing/transfer/statistics,/api/erp/ae/supplier/listSupplierActive,/api/erp/ae/supplier/list,/api/erp/ae/supplier/listSupplier,/api/erp/ae/warehouse/getWarehouseList',
    ...
    routes: [
      {
        ...
        title: '客户信息日志查询',
        apiPath:
          '/api/erp/ae/phoneView/listViewDetail,/api/erp/ae/goodsCodeAssign/list,/api/erp/ae/phoneView/listPhoneView,/api/erp/ae/phoneView/listAllDept',
    ...
    routes: [
      {
        ...
        title: '进销汇存总表',
        apiPath:
          '/api/erp/ae/goodsCodeAssign/list,/api/erp/ae/invoicing/list,/api/erp/ae/warehouse/getWarehouseList,/api/erp/ae/invoicing/export,/api/erp/ae/purchase-order/export,/api/erp/ae/price-adjust-result/export,/api/erp/ae/order/exportOrder,/api/erp/ae/order/showTask,/api/ae/common/showTask,/api/erp/ae/inventory/product/exportGoodsInventory',
